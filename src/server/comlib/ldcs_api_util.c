...
char* _message_type_to_str (ldcs_message_ids_t type) {
   switch (type) {
      ...
      STR_CASE(LDCS_MSG_LSTAT_QUERY);      
      STR_CASE(LDCS_MSG_STAT_ANSWER);
      STR_CASE(LDCS_MSG_STAT_ANSWER_SELF);      
      STR_CASE(LDCS_MSG_STAT_NET_REQUEST);
      STR_CASE(LDCS_MSG_LSTAT_NET_REQUEST);      
      STR_CASE(LDCS_MSG_STAT_NET_RESULT);
      STR_CASE(LDCS_MSG_LSTAT_NET_RESULT);      
      ...
      STR_CASE(LDCS_MSG_DIRLISTS_REQ);
      STR_CASE(LDCS_MSG_DIRLISTS_RESP);      
      ...
      STR_CASE(LDCS_MSG_CLIENT_STATICTLS);
