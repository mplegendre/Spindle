...
typedef enum {
   ...
   LDCS_MSG_DSO_QUERY,
   LDCS_MSG_DSO_QUERY_EXACT_PATH,
   LDCS_MSG_FILE_QUERY_ANSWER,
   LDCS_MSG_FILE_ERRCODE,
   LDCS_MSG_FILE_REQUEST,
   LDCS_MSG_STAT_QUERY,
   LDCS_MSG_LSTAT_QUERY,   
   LDCS_MSG_STAT_ANSWER,
   LDCS_MSG_STAT_ANSWER_SELF,   
   LDCS_MSG_STAT_NET_REQUEST,
   LDCS_MSG_LSTAT_NET_REQUEST,   
   LDCS_MSG_STAT_NET_RESULT,
   LDCS_MSG_LSTAT_NET_RESULT,   
   LDCS_MSG_EXISTS_QUERY,
   LDCS_MSG_EXISTS_ANSWER,
   LDCS_MSG_ORIGPATH_QUERY,
   LDCS_MSG_ORIGPATH_ANSWER,   
   LDCS_MSG_END,
   LDCS_MSG_CWD,
   LDCS_MSG_PID,
   LDCS_MSG_COMMPATH,
